...
export const Route = createFileRoute("/purchase-point")({
  head: () => ({
    meta: [
      { title: "Punto de compra — Multimarket" },
      { name: "description", content: "Registrar facturas de compra a proveedores y actualizar inventario." },
      { property: "og:title", content: "Punto de compra — Multimarket" },
...
function Purchases() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-semibold tracking-tight">Punto de compra</h1>
