...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Gestión de ventas, inventario, cuentas por cobrar y pagar." },
      { property: "og:title", content: "Multimarket — Sistema de ventas" },
      { property: "og:description", content: "Gestión de ventas, inventario, cuentas por cobrar y pagar." },
